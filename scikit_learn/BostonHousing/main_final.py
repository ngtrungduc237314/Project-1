...
plt.title(
    "Actual vs Predicted\n"
    "(Log + Trim + Remove TAX + ZN Binarization)"
)
...
"""
ket hop log transform bien price, crim, lstat; trimming cho rm, ptratio; xoa bo bien tax, binarization bien zn.
"""