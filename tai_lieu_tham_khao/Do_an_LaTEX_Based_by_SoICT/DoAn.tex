...
\setlength{\headheight}{15pt} % Đặt chiều cao cho vùng header để tránh lỗi cảnh báo của fancyhdr.
...
\author{NGUYỄN VĂN ABC} % Khai báo tác giả cho tài liệu.
...
\begin{document}
	...
	\subfile{Chuong/0_1_De_tai_TN.tex}
