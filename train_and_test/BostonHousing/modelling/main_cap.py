...
# Capping cho các biến
data = cap_outliers_iqr(data, 'rm')
data = cap_outliers_iqr(data, 'dis')
data = cap_outliers_iqr(data, 'ptratio')

# =========================
# 2.5. Boxplot after capping
# =========================
plt.figure(figsize=(15, 4))

plt.subplot(1, 3, 1)
sns.boxplot(x=data['rm'])
plt.title("RM after capping")

plt.subplot(1, 3, 2)
sns.boxplot(x=data['dis'])
plt.title("DIS after capping")

plt.subplot(1, 3, 3)
sns.boxplot(x=data['ptratio'])
plt.title("PTRATIO after capping")
