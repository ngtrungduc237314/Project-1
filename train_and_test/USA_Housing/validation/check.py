...
print("=" * 70)
print("USA HOUSING DATA QUALITY VALIDATION")
print("=" * 70)
...
range_rules = {
    "Avg. Area Income": (0, 1000000),
    "Avg. Area House Age": (0, 100),
    "Avg. Area Number of Rooms": (0, 50),
    "Avg. Area Number of Bedrooms": (0, 20),
    "Area Population": (0, 10000000),
    "Price": (0, 100000000)
}
...
if "Address" in df.columns:
    ...
    for idx in invalid_rows.index:
        ...
        errors.append({
            "row_index": idx,
            "column": "Address",
            "invalid_value": df.loc[idx, "Address"],
            "error_type": "Invalid Address"
        })
...
errors_df.to_csv(
    "validation_results/USA_Housing_data_quality_errors.csv",
    index=False
)

missing_summary.to_csv(
    "validation_results/USA_Housing_missing_summary.csv"
)

print("\nFiles saved:")
print("1. validation_results/USA_Housing_data_quality_errors.csv")
print("2. validation_results/USA_Housing_missing_summary.csv")
...
print("USA Housing data quality validation completed successfully.")