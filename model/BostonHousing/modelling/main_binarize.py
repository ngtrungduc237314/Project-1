...
# Binarization cho biến ZN
# =========================

print("\nUnique values before binarization:")
print(sorted(data['zn'].unique())[:20])

# Nếu zn > 0 -> 1
# Nếu zn = 0 -> 0

data['zn'] = np.where(data['zn'] > 0, 1, 0)

print("\nUnique values after binarization:")
print(data['zn'].unique())
